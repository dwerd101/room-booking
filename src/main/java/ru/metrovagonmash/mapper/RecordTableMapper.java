...
public interface RecordTableMapper extends VCMapper<RecordTable, RecordTableDTO> {
    @Mappings({
            ...
            @Mapping(target="numberRoomId", source="recordTable.numberRoomId.id"),
            @Mapping(target="employeeId", source="recordTable.employeeId.id")
    })
    ...
    @Mappings({
            ...
            @Mapping(target="numberRoomId.id", source="recordTableDTO.numberRoomId"),
            @Mapping(target="employeeId.id", source="recordTableDTO.employeeId")
    })
